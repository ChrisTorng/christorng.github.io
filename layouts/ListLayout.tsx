  ...
  return (
    <>
      <div className="divide-y divide-gray-200 dark:divide-gray-700">
          ...
          <div className="relative max-w-lg">
            <label>
              ...
              <input
                ...
                placeholder="搜尋文章"
                className="focus:border-primary-500 focus:ring-primary-500 block w-full rounded-md border border-gray-300 bg-gray-100 px-4 py-2 text-gray-800 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-200"
              />
            </label>
            <svg
        ...
        <ul>
          {!filteredBlogPosts.length && '沒有找到文章。'}
