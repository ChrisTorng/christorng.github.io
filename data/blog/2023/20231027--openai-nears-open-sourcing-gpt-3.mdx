...
The original article ([OpenAI 開源 GPT-3 系列模型時間已近](/blog/20231027-openai-gpt-3/)) was written in Traditional Chinese. Below is the version translated by AI.

## **Previous Predictions**

Following the leak of internal meeting information from OpenAI on May 29, 2023 ([OpenAI's plans according to Sam Altman](https://web.archive.org/web/20230531203946/https://humanloop.com/blog/openai-plans)), I wrote an article on June 4th, titled [Discussing OpenAI's Open Sourcing of GPT-3 and Recent GPT-4 Quality Issues](/blog/20230604-discussing-openais-open-sourcing/). In it, I predicted that GPT-3 would be open-sourced by the end of this year (2023) or early next year. Below are excerpts from my article:
